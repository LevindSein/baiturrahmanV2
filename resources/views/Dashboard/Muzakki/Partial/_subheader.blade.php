...
<div class="subheader py-4 py-lg-6 subheader-transparent" id="kt_subheader">
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <!--begin::Actions-->
            <a href="javascript:void(0)" id="add" class="btn btn-light-success font-weight-bolder btn-sm"><i class="fas fa-plus fa-sm"></i>@include('Dashboard.Muzakki.Partial._title')</a>
            <!--end::Actions-->
        </div>
        <!--end::Toolbar-->
    </div>
