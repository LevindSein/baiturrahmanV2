    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah @include('Dashboard.Mustahik.Partial._title')</h5>
            ...
            <form id="tambah-form">
                <div class="modal-body" style="height: 45vh;">
                    <div class="form-group">
                        ...
                        <input required type="text" id="tambah-name" name="tambah_name" autocomplete="off" maxlength="100" class="form-control" placeholder="Masukkan Nama Mustahik" />
                    </div>
                    <div class="form-group">
...
$('#tambah-form').on('submit', function(e){
    ...
    $.ajax({
        url: "/production/dashboard/mustahik",
        cache: false,
        method: "POST",
        data: $(this).serialize(),
        dataType: "json",
