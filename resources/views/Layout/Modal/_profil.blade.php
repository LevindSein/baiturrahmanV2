            ...
            <form id="profil-form">
                <div class="modal-body" style="height: 45vh;">
                    <div class="form-group">
                        ...
                        <input required type="text" id="profil-username" name="profil_username" autocomplete="off" maxlength="100" class="form-control" placeholder="Masukkan Username untuk Login" />
                    </div>
                    <div class="form-group">
